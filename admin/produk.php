									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												<a class="dropdown-item" href="produk-detail.php?id=<?php echo $row['id_produk']; ?>">
													<i class="dw dw-eye"></i> Detail
												</a>
												<a class="dropdown-item" href="produk-update.php?id=<?php echo $row['id_produk']; ?>">
													<i class="dw dw-edit-1"></i> Update
												</a>
												<a class="dropdown-item" href="produk-delete.php?id=<?php echo $row['id_produk']; ?>">
                        ...
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
									...
									<div class="form-group row">
										<label class="col-sm-4 col-form-label">Mesin<span style="color:red;">*</span></label>
										<div class="col-sm-8">
											<select class="custom-select col-12" name="mesin">
												<option selected disabled>Pilih...</option>
												<option value="MT">MT</option>
												<option value="CVT MT">CVT MT</option>
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<textarea class="form-control" name="keterangan" placeholder="" required style="height:100px;"></textarea>
										</div>
									</div>
									<div class="form-group row">
										<label class="col-sm-4 col-form-label">Youtube</span></label>
										<div class="col-sm-8">
